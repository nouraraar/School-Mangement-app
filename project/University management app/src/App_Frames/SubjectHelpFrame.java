 ...
 */
public class SubjectHelpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        constraintTA.setText("1: Each Subject description can't be empty and\ncan't pass 30 Characters length.\n \n2: Each Subject must have a working Hours \nwich is an unsigned number greater than 0.\n\n3: Each Subject must have a level and  a field .\n\nNotes: \n\t- you must provide an existing Teacher's \nCIN in the database and select the field and the\nlevel of the class in wich that teacher \nanimate the subject .\n- When adding a new subject , all of the\nfields must be filled. \n\t- removing or editing a subject can be \ndone after selecting the subject .\n\t- you can search for a subject by filling\nany of its infromations and the table below\nthat contains all of the subject will be \nfiltered , so you can find the subject you are \nlooking for in that list .\t\n\t-You can always export the list of \nsubject contained inner the table to Google\nsheets , so you can manipulate it or send it\nor print it or even use it \nin statics .");
        ...
        aboutUsLabel.setText("Subject constraints");
