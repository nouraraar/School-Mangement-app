...
public class TeacherSubjectFrame extends javax.swing.JFrame {
     ...
     */
    public TeacherSubjectFrame(String server_ip,int PORT,User user,String cin) {
        this.cin=cin;
        this.user = user;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                 ...
                 try {
                            ...
                            out.writeObject("+get_teacher_subjects");//undecating to server that it's a show all studnets request
                            out.writeObject(new Teacher(cin,null,null,null,null,null,-1,null,false));
        ...
        while(model.getRowCount()>0)
            model.removeRow(0);
                                ...
                                for(Subject subject : result)
                                {
                                    ...
                                    row[2] = subject.getLevel();
                                    row[3] = (int)subject.getVolume();
                                    
                                     int tmp = subject.getFieldId();
                                    switch(tmp)
                                    {
                                        case 1:row[1]="MPI";break;
                                        case 2:row[1]="CBA";break;
                                        case 3:row[1]="RT";break;
                                        case 4:row[1]="GL";break;
                                        case 5:row[1]="IIA";break;
                                        case 6:row[1]="IMI";break;
                                        case 7:row[1]="CH";break;
                                        default:row[1]="BIO";
    ...
    private void initComponents() {
        ...
        resultTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Subject description", "Field", "Level", "volume"
            }
        ) {
